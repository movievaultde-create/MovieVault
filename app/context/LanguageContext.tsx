...
const translations = {
  ...
  navMyList: { EN: "My List", AR: "قائمتي", DE: "Meine Liste", FR: "Ma liste", ES: "Mi lista", TR: "Listem" },
  ...
  detailsTab: { EN: "Details", AR: "التفاصيل", DE: "Details", FR: "Détails", ES: "Detalles", TR: "Detaylar" },
  infoTab: { EN: "Info", AR: "المعلومات", DE: "Infos", FR: "Infos", ES: "Info", TR: "Bilgi" },
  castTab: { EN: "Cast", AR: "الشخصيات والطاقم", DE: "Besetzung", FR: "Acteurs", ES: "Reparto", TR: "Oyuncular" },
  roleMain: { EN: "Main", AR: "رئيسي", DE: "Hauptrolle", FR: "Principal", ES: "Principal", TR: "Ana" },
  roleSupporting: { EN: "Supporting", AR: "مساعد", DE: "Nebenrolle", FR: "Secondaire", ES: "Secundario", TR: "Yardımcı" },
